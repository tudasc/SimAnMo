...
{\large
\begin{equation}
f_{model}(x) = -0.46 + 0.00840531 * 2 ^ {0.1 * x ^ {0.88}}
\end{equation}\begin{itemize}
\item Thread 2 found solution in 29014686 steps requiring 0 seconds.
\item Cost ( raRSD ):0.00609376
\item Metrics of our model: RSS: 0.002733 / anRSS: 0.002281 / arNRS: 0.006094\end{itemize}
}
\begin{figure}[htb]
\centering
...
(\x, {-0.460883 + 0.00840531 * 2 ^ (0.104277 * \x ^ (0.883726)) });
\addlegendentry{Our model $-0.46 + 0.00840531 * 2 ^ {0.1 * x ^ {0.88}}$ };
...
\addplot [name path=func, domain=142:300, samples=110,unbounded coords=jump, draw=blue, very thick] 
(\x, {-0.460883 + 0.00840531 * 2 ^ (0.104277 * \x ^ (0.883726)) });
\addlegendentry{Exp-pol $-0.46 + 0.00840531 * 2 ^ {0.1 * x ^ {0.88}}$ };
...
\end{figure}
{\large\begin{itemize}
\item Deviation of our model and reference at x=164 is 78.3034\%.
\end{itemize}}
{\large\begin{itemize}
\item Deviation of our model and measures at x=164 is 3.20457\%.
