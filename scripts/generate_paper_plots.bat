SET SHARED_FLAGS=--ci 0.1 --pc --gl --ll --outpath "../outputs" --nt 8 --pcd --epmae 2.00 --epmic 0.003
...
start "" /wait ../bin/SiMaNo.exe --inputfile "../inputs/enumtheory.txt" --texfile "enumtheory" %SHARED_FLAGS% %SHARED_ANN_FLAGS%

start "" /wait ../bin/SiMaNo.exe --inputfile "../inputs/synt9.txt" --texfile "synt9"  %SHARED_FLAGS% %SHARED_ANN_FLAGS% --epmae 3.19 --epmic 0.0001
