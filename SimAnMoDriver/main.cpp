...
int main(int argc, char** argv)
{
	...
	SimAnMo::FunctionModel modi = SimAnMo::findModel(m1, mmess, " --pcd --texfile fplll1.00vTest --outpath ../outputs  --nt 4  --ann_steps_wo_mod 20000 --ann_steps 1 --ann_cooling_rate 0.998 --ann_target_temp 1e-14");
